...
def run_fomc_pipeline():
    ...
    statement_current = read_input(f"{FOMC_INPUT_DIR}/statement_current.pdf")
    statement_previous = read_input(f"{FOMC_INPUT_DIR}/statement_previous.pdf")
    sep_text = read_input(f"{FOMC_INPUT_DIR}/sep.pdf")
...
"""
    ...
    morning_brief_text = generate_with_retry(morning_brief_prompt)
    ...
    return {
        "intermediate_dir": FOMC_INTERMEDIATE_DIR,
        "dotplot_path": dotplot_path_out,
